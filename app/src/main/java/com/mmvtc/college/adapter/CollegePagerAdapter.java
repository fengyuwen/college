...
public class CollegePagerAdapter extends PagerAdapter {
    ...
    public CollegePagerAdapter(List<String> dataList,Context context,final ShowHeadView showHeadView) {
        mDataList = dataList;
        mContext=context;
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            adapters.add(new CollegeNewsAdapter(mContext, new ArrayList<NewsBean>()));
